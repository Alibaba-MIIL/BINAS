...
def extract_list_alphas(model):
    ...
    for (s, stage), beta_attention, beta in zip(sink_points, model.beta_attention, model.beta):
        ...
        list_alphas.append(entry)
        list_alphas += alpha_entries
...
def _extract_alpha_beta_and_associated_modules_elastic(model, file_name=LATENCY_FILENAME,
    ...
    dict_latency = compute_latency(model, list_alphas, file_name=file_name, batch_size=batch_size,
    ...
    return list_alphas, fixed_latency
