...
def add_nas_to_parser(parser):
    ...
    parser.add_argument('--delta_lp', type=float, default=None,
                        help='Maximum delta to move when using the lp')
    parser.add_argument('--tol_lp', type=float, default=1e-5,
                        help='Maximum tolerance for the lp')
    parser.add_argument('--lp_method', type=str, default='revised simplex',
                        help='lp method used')
